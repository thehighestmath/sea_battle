...
class Ui_GameWindow(object):
    def setupUi(self, GameWindow):
        ...
        self.finishSettingShips.setStyleSheet("QPushButton{\n"
"background: white;\n"
"border: none;\n"
...
"}")
        ...
        self.shuffleShips.setStyleSheet("QPushButton{\n"
"background: white;\n"
"border: none;\n"
"border: 1px solid #bbb;\n"
"max-width: 150px;\n"
...
"}")
        ...
        self.gridLayout.addWidget(self.centralWidget, 1, 0, 1, 1)
        self.menu = QtWidgets.QPushButton(GameWindow)
...
"}")
    ...
    def retranslateUi(self, GameWindow):
        ...
        self.finishSettingShips.setText(_translate("GameWindow", "Завершить"))
